...
using CrudInvent.Models;

namespace CrudInvent.Controllers
{
    public class CadastroesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Idade")] Cadastro cadastro)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Idade")] Cadastro cadastro)
        {
            if (id != cadastro.Id)
            {
                return NotFound();
